 ...
 * Mục đích: Modal component với overlay và backdrop
 * Vai trò:
 *   - Hiển thị nội dung modal ở giữa màn hình
 *   - Có backdrop tối để focus vào modal
 *   - Có nút X để đóng modal
 *   - Click outside để đóng modal
 * Lưu ý:
 *   - Sử dụng fixed positioning và z-index cao
