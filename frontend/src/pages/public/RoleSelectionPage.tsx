    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Link
            to="/register/tutor"
            className="group bg-white rounded-3xl shadow-xl p-8 border-2 border-gray-100 hover:border-green-300 hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
          >
            <div className="text-center">
              <div className="text-6xl mb-6 group-hover:scale-110 transition-transform duration-300">
                🎓
              </div>
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Tôi là Gia sư</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Chia sẻ kiến thức và kiếm thu nhập ổn định từ việc dạy học. Yêu cầu xét duyệt để đảm
                bảo chất lượng.
              </p>
              ...
              <ul className="text-left space-y-3 mb-8 text-gray-600">
                ...
                <li className="flex items-center">
                  <span className="text-green-500 mr-3 text-lg">✓</span>
                  Nhận lương cao, ổn định
                </li>
                <li className="flex items-center">
                  <span className="text-green-500 mr-3 text-lg">✓</span>
                  Công cụ dạy học hiện đại
                </li>
              </ul>

              <div className="bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-xl font-semibold text-lg group-hover:from-green-600 group-hover:to-green-700 transition-all duration-300">
                Đăng ký làm Gia sư →
              </div>
            </div>
          </Link>
